...
getHTML.onclick = function () {
  ...
  request.onload = function () {
    // 创建 div 标签
    var div = document.createElement('div'); // 填写 div 内容
...
getJS.onclick = function () {
  ...
  request.onload = function () {
    // 创建 script 标签
    var script = document.createElement('script'); // 填写 script 内容

    script.innerHTML = request.response; // 插到 body 里面
...
//# sourceMappingURL=main.23637c0b.js.map